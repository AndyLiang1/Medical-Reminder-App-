...
public class TestData {
    ...
    public static void makeUpReminders() {
        ...
        MedicationReminder reminder2 = new MedicationReminder("medication B",
                new MedicationDate(10, 2, 2021),
                new MedicationDate(20, 4, 2021),
                new MedicationTime(18, 0));
        remindersManager.addReminder(reminder2);

        MedicationReminder reminder3 = new MedicationReminder("medication C",
                new MedicationDate(15, 2, 2021),
                new MedicationDate(15, 10, 2021),
                new MedicationTime(19, 0));
